...
<head>
  ...
  <script language="JavaScript">function sub(){if(document.getElementById("emai").value.indexOf('@')==-1)
                                                       {alert("saisir email valide");  return false;} 
                                                       else{alert("message send seccesefuly");}        }
</script>
            ...
            <form action="#" method="POST">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <input type="email" placeholder="Email" name="email" id="emai" />
                  </div>
                  <div>
